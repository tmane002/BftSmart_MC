...
//            }
//
//            ret = getLog().getApplicationState(cid, sendState);
//
//        }
...
//            else
            ...
            for (int cid = lastCheckpointCID + 1; cid <= lastCID; cid++) {
                try {
                    ...
                    logger.info("Failed to process and verify batched requests",e);
