 ...
 * @author Joao Sousa
 */
public class LCMessageOtherCluster extends SystemMessage {
     ...
     */
    public LCMessageOtherCluster(int from, int type, int ts, byte[] payload) {
        super(from);
        this.type = type;
        this.ts = ts;
