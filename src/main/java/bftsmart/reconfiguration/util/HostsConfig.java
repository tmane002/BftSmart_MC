...
public class HostsConfig {
    ...
    private HashMap<Integer, ClientConfig> clients = new HashMap<>();



    public HashMap<Integer,Config> getServers()
    {
        return this.servers;
    }
            ...
            while((line = rd.readLine()) != null){
                if(!line.startsWith("#")){
                    ...
                    if(str.countTokens() == 5){
                        ...
                        int port = Integer.valueOf(str.nextToken());
                        int portRR = Integer.valueOf(str.nextToken());
                        int ClusterNumber = Integer.valueOf(str.nextToken());
                        this.servers.put(id, new Config(id, host, port, portRR, ClusterNumber));
                    }
                    ...
                    if(str.countTokens() == 3){
                        ...
                        String host = str.nextToken();
                        int port = Integer.valueOf(str.nextToken());
                        this.clients.put(id, new ClientConfig(id, host, port));
                    }
    ...
    public class Config{
        ...
        public Config(int id, String host, int port, int portRR, int ClusterNumber){
            this.id = id;
            this.host = host;
            this.port = port;
            this.portRR = portRR;
    ...
    public class ClientConfig{
        ...
        public ClientConfig(int id, String host, int port){
            this.id = id;
            this.host = host;
            this.port = port;
        }
